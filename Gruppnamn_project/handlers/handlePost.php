<?php 
    ...
    $title          = (!empty($_POST['title']) ? $_POST['title'] : ""); // om tom = tom string
    ...
    $query = "INSERT INTO posts (title, description) VALUES(:title, :description);"; //tar värdena från tabellen. Kolon gör att den förstår att det är variabeler.
